...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\core.jar;%APP_HOME%\lib\sqlite-jdbc-3.45.2.0.jar;%APP_HOME%\lib\slf4j-api-1.7.36.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" server.ChatServer %*
