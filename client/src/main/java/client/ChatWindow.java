...
/**
 * ChatWindow que gestiona multiples conversaciones en pestañas.
 */
public class ChatWindow extends JFrame {
    ...
    public ChatWindow() {
        ...
        // Abrir primer chat automaticamente
        openTab();
    }

    private void openTab() {
        // LoginDialog pide nick, avatar, ip, puerto
        LoginData data = LoginDialog.showDialog(this);
        if (data == null) return;
        // Creamos panel de conversacion
